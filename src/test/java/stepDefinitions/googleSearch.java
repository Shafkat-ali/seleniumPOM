...
public class googleSearch {
	...
	public void user_is_on_google_site() {
	   BaseClass.getDriver().get(ConfigsReader.getProperty("url2"));
	}
	...
	public void user_searchs_for_i_phone_in_a_search_bar() {
		BaseClass.getDriver().findElement
		(By.xpath("/html/body/div[1]/div[3]/form/div[1]/div[1]/div[1]/div/div[2]/input"))
	...
	public void search_should_yield_list_of_iphones_in_the_results() {
	    BaseClass.getDriver().findElement(By.xpath("//*[@id=\"result-stats\"]")).isDisplayed();
